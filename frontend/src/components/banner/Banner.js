        ...
        <div className="row no-gutters align-items-center pt-60px">
          ...
          <div className="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div className="hero-banner__content">
              ...
              <p>Us which over of signs divide dominion deep fill bring they're meat beho upon own earth without morning over third. Their male dry. They are great Bannerear whose land fly grass.</p>
